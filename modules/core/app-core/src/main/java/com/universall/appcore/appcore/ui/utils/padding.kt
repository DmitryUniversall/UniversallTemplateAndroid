...
@Composable fun Modifier.paddingScreen() =           padding(vertical = Locals.spacing.screenPadding, horizontal = Locals.spacing.screenPadding)
@Composable fun Modifier.paddingHorizontalScreen() = padding(horizontal = Locals.spacing.screenPadding)
@Composable fun Modifier.paddingVerticalScreen() =   padding(vertical = Locals.spacing.screenPadding)
